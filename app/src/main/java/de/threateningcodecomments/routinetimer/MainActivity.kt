...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ResourceClass.setErrorDrawable(ResourcesCompat.getDrawable(resources, R.drawable.ic_defaultdrawable, theme))
    }
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.btn_mainActivity_setup -> {
                val intent = Intent(this@MainActivity, SelectRoutine::class.java)
            ...
            else -> Toast.makeText(this, "Unknown Error, please see developer or priest", Toast.LENGTH_LONG).show()
        }
    }
    ...
    override fun onStart() {
        super.onStart()
        updateUI()
        ResourceClass.updateNightMode(application)
    }
    ...
    private fun handleGreetNoAccount() {
        val errorDrawable = ContextCompat.getDrawable(this, R.drawable.ic_defaultdrawable)
        profilepicview!!.setImageDrawable(errorDrawable)
        usernameView!!.text = getString(R.string.str_tv_MainActivity_login)
        val bgColor: Int
        bgColor = if (ResourceClass.isNightMode(application)) {
    ...
    private fun signOut() {
        ...
        mGoogleSignInClient!!.signOut()
                .addOnCompleteListener(this) { MyLog.f("Logged out of google account!") }
